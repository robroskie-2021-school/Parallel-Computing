...
/*
Results
    Using both the non-reduction and reduction methods yield similar results.

Output
    Enter a, b, and n
    0 50000000 5000000

    Total time used by Thread 0 is 12.8670ms
    Total time used by Thread 2 is 12.8910ms
    Total time used by Thread 1 is 15.9820ms
    Total time used by Thread 3 is 16.0360ms

    Total time used by all parallel regions is 57.7760ms
